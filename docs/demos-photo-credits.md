# Demo Hero Photo Credits — Phase A

All hero images for the 30 marketing themes are sourced from free-for-commercial-use stock libraries. Attribution is recorded here as a courtesy / audit trail; neither licence requires customer-facing credit.

## Licences
- **Unsplash License** — free to use for any purpose, including commercial; attribution not required. <https://unsplash.com/license>
- **Pexels License** — free for personal and commercial use; attribution not required. <https://www.pexels.com/license/>

## Source resolution + budget
- Downloaded at 1400px wide.
- Re-encoded with `sharp` (mozjpeg) at progressively lower quality until ≤ 180 KB (hard cap 200 KB).
- See `scripts/fetch-hero-images.mjs` for the exact pipeline.
...
|---|---|---|---|---|
| `ironside-plumbing` | Plumber's hand tightening a brass fitting on copper pipework | Sigmund | [Unsplash](https://unsplash.com/photos/Hk7HD7ICz4o) | Unsplash |
| `greenwise-lawn` | Freshly cut green lawn in strong daylight | Petar Tonchev | [Unsplash](https://unsplash.com/photos/NEJcmvLFcws) | Unsplash |
...
| `crystalline-window-co` | Modern building facade with rows of clean glass windows | Joel Filipe | [Unsplash](https://unsplash.com/photos/Wc8k-KryEPM) | Unsplash |
...
| Slug | Image content | Photographer | Source | Licence |
|---|---|---|---|---|
| `angelos` | Overhead shot of a freshly baked pizza on a rustic wooden table | Ivan Torres | [Unsplash](https://unsplash.com/photos/MQUqbmszGGM) | Unsplash |
| `brutalist` | Stark concrete architectural geometry with strong shadows | Joel Filipe | [Unsplash](https://unsplash.com/photos/jM6Y2nhsAtk) | Unsplash |
| `cask-vine` | Glasses of red wine on a dark wooden bar in warm low light | Kelsey Knight | [Unsplash](https://unsplash.com/photos/AeS6Q_PHsk0) | Unsplash |
| `cinematic-dark` | Cinematic low-key portrait silhouette in deep amber and shadow | Jakob Owens | [Unsplash](https://unsplash.com/photos/5xFYatcm2Z4) | Unsplash |
| `daylight-lounge` | Warm sunlit lounge interior with natural woods and soft textiles | Spacejoy | [Unsplash](https://unsplash.com/photos/9M66C_w_ToM) | Unsplash |
| `documentary-b2b` | Professionals reviewing documents around a conference table | Austin Distel | [Unsplash](https://unsplash.com/photos/rxpThOwuVgE) | Unsplash |
| `doorstep-editorial` | Brown cardboard parcel sitting on a clean residential doorstep | Claudio Schwarz | [Unsplash](https://unsplash.com/photos/purzlbaum) | Unsplash |
| `mara-lin` | Editorial portrait against a dark backdrop with soft directional light | Ali Pazani | [Unsplash](https://unsplash.com/photos/bIlc70I2Z3I) | Unsplash |
| `north-fork` | Pint glass of amber beer on a wooden bar in a warm taproom | Adam Wilson | [Unsplash](https://unsplash.com/photos/WGiqQVnvyJI) | Unsplash |
| `premium-trade` | Tradesperson's tools laid out on a clean workbench | Theme Photos | [Unsplash](https://unsplash.com/photos/9aOswReDKPo) | Unsplash |
| `print-block-books` | Densely packed bookstore shelves seen from a low angle | Patrick Tomasso | [Unsplash](https://unsplash.com/photos/Oaqk7qqNh_c) | Unsplash |
