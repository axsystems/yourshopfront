...
export function CopyUrlButton({ url, className }: CopyUrlButtonProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-md text-apx-soft transition-colors hover:bg-apx-tint hover:text-apx-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-apx-primary focus-visible:ring-offset-2",
        className
      )}
    >
      {copied ? (
