...
// is registered at '2025-12-15.clover', independent of this pin), which is
// why constructEvent's return type is asserted against Stripe.Event rather
// than derived from STRIPE_API_VERSION. If webhook payload assumptions ever
// need re-verifying, check the endpoint's registered version, not this
// constant. The setup script (scripts/create-stripe-products.ts) is
// allowed to run unpinned because it isn't sensitive to either.
//
