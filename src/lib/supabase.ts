...
// -----------------------------------------------------------------------------
// SiteContent — customer-authored content the tenant page renders
// -----------------------------------------------------------------------------
// Persisted as JSONB in sites.site_content (added in migration
// 0004_site_content.sql). Mirrored in Zod at src/lib/site-content/schema.ts;
// edit both when adding/removing fields.
//
// Every section is optional at the type level so the worksheet can save
// section-by-section. The "is this enough to launch" bar lives in
// `siteContentIsValid` below (and CompleteSiteContentSchema in Zod).
