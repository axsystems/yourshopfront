...
const QUESTIONS = [
  ...
  },
  {
    ...
    a: "We have 30 designs available as theme options — every one is buyable under either tier. The 10 featured on the homepage are our front-of-store picks; the other 20 live in the portfolio. If none fits, get in touch — we add new themes regularly and may have something in the pipeline that suits you.",
  },
  {
