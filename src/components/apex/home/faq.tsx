...
const QUESTIONS = [
  ...
  },
  {
    ...
    a: "We have 24 designs available, every one buyable under either tier. The 10 featured on the homepage are our highest-converting starting lineup; the other 14 live in the portfolio. If none fits, get in touch — we add new themes regularly.",
  },
  {
